...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://raw.ihtw.moe/raw.githubusercontent.com/li-peifeng/iSweeTv/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/LibreSpark/li-peifeng/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/li-peifeng/iSweeTv', '_blank');
                    });
                }
            }, 100);
        } else {
