    ...
    modal.innerHTML = `
        <div class="bg-[#191919] rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto relative">
            ...
            <div class="mb-0">
                ...
                <div class="text-sm font-medium text-gray-300 mb-4">此功能会删除你的观看记录、自定义 API 接口和 Cookie</div>
                <div class="text-sm font-medium text-gray-300 mb-4"><scan class="text-red-500 font-bold">此操作不可恢复！</scan></div>
